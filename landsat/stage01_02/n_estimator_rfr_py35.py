...
def getCmdargs():
    ...
    p.add_argument("--itera",default=2, type=int, help="number of iterations of the model (default=%(default)s)")
    #p.add_argument("--n_estimators", type=int, default=100,
        #help="Number of estimators in random forest models (default=%(default)s)")
...
def RFRmodel(cmdargs,n_est):
    ...
    xdata1 = df1[df1.columns[cmdargs.nskipcols:42]].astype('float32')
